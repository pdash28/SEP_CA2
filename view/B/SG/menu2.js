...
<script>\
    document.addEventListener("DOMContentLoaded", function() {\
        ...
        if (memberEmail == null || memberEmail == "") {\
            ...
            document.getElementById("favouritesLink").setAttribute("style", "display:none");\
        } else {\
            ...
            document.getElementById("favouritesLink").setAttribute("style", "display:block");\
            var welcomeText = sessionStorage.getItem("memberName");\
            if (welcomeText == "null" || welcomeText == null || welcomeText == "") {\
                welcomeText = "";\
            }\
        ...
        <div id="menuLoggedOut" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li id="servicesLink">\
                        <a href="/B/' + countryPrefix + '/services.html"> Our Services</a>\
                    </li>\
                    <li>\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li id="favouritesLink" style="display: none;">\
